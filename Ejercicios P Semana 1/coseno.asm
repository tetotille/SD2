#Edicion del programa del seno del ing. Marcos Redondo
#por Jorge Tilleria, Alejandro Maciel, Julio Avalos
...
.text
    ...
    ld $a2, delta
    jal coseno	#se llama a la funcion seno
    mtc1.d  $v0, $f12
    li $v0, 3 		#servicio para imprimir double
    syscall
...
#	     $a2, a3 => error (double)
#outputs:$v0, $v1 => resultado cos(x) (double)
coseno:
...
whileMenor:
c.le.d $f6, $f4 
bc1t end_while #si la bandera 0 está en 1 salta
sll $t1, $s0, 1 #2k
#addi $t1, $t1, 1 #2k

mfc1.d $a0, $f2 #
move $a2, $t1 #exponente
jal potencia
mtc1.d $v0, $f6
...
mtc1 $a0, $f0 #base de la potencia
mtc1 $a1, $f1
add $t0, $zero, $a2 # t0 = exponente
